...
set_arg!(slider_w, :model, translationmatrix(Vec3f0(iconsize*2+10, 0, 0)))
...
_view(
    layout!(SimpleRectangle{Float32}(iconsize,0,iconsize,iconsize), buttobj),
    edit_screen, camera=:fixed_pixel
)
_view(
    layout!(SimpleRectangle{Float32}(10,10,iconsize,iconsize), a_v),
    edit_screen, camera=:fixed_pixel
)
